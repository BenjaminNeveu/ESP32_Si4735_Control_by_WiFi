...
|  |  |
|--|--|
|Une fois le programme compillé, vous allez téléverser <br>le contenu du répertoire ``data`` qui contient l'interface,<br> pour ceci vous allez cliquer sur ``Outils`` puis sur ``ESP32 Sketch Data Upload``|![](04_extras/screen-install-readme/televerser_data.png)|
